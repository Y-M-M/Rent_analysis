...
for i in range(1, 401):
    url = "https://qd.lianjia.com/zufang/pg" + str(i) + "/#contentList"
    get_house_info(url)
    if i % 50 == 0:
        time.sleep(100)
    time.sleep (5)

with open('../initaldata/qddata.csv', 'w', newline='', encoding='utf-8') as csvfile:
